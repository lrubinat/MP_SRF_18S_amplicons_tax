...
tb18_ss8524_tax<-merge(tb18_tax_occur_ss8524_no_cero_t,tb18_class, by="row.names")

dim(tb18_ss8524_tax)
tb18_ss8524_tax[1:5,1:5]

#fix OTU_no as new row
rownames(tb18_ss8524_tax)=tb18_ss8524_tax$Row.names
...
tb18_ss8524_tax["OTU_no"] <- NA
tb18_ss8524_tax$OTU_no <- sapply(strsplit(rownames(tb18_ss8524_tax),split= "\\_"),'[',2)
tb18_ss8524_tax$OTU_no <- as.numeric(as.character(tb18_ss8524_tax$OTU_no))
tb18_ss8524_tax_sorted<-tb18_ss8524_tax[order(tb18_ss8524_tax$OTU_no, decreasing = FALSE), ]

dim(tb18_ss8524_tax_sorted)
tb18_ss8524_tax_sorted[1:5,1:5]
```

```{r select_phototrophs, echo=FALSE}
tb18_phototrophs <- tb18_ss8524_tax_sorted[which(tb18_ss8524_tax_sorted$MAS_plus_BM_plus_SILVA_class != "NA"),]
...
class_summary<-aggregate(tb18_phototrophs, list(tb18_phototrophs$MAS_plus_BM_plus_SILVA_class), length)
